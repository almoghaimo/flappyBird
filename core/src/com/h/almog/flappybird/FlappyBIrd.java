package com.h.almog.flappybird;
...
public class FlappyBIrd extends ApplicationAdapter {
	SpriteBatch batch;
	Texture background, bottomTube, topTube; // image.
//	ShapeRenderer shapeRenderer;

	Texture gameOver;
	Texture[] birds;
	int flapState = 0; // track of which one we want to display each time
	float birdY = 0;
	float velocity = 0;
	...
	// when the app is in process
	// this method is run again and again all the time
	@Override
	public void render () {
		...
		font.draw(batch, String.valueOf(score), 100, 200); // the last two is start left and stop left
